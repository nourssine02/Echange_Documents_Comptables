...
app.post("/facture", verifyToken, (req, res) => {
  ...
  // Vérifier que les champs nécessaires de la facture sont bien présents
  const requiredFields = [
    'date_facture', 'num_facture', 'montant_total_facture', 'observations', 'document_fichier', 
    'etat_payement'
  ];

  const missingFields = requiredFields.filter(field => !facture[field]);
