...
app.post('/reglements_emis', verifyToken, (req, res) => {
  ...
  db.beginTransaction((err) => {
    ...
    db.query(insertReglementQuery, [
      reglementData.date_saisie || null,
      reglementData.code_tiers || null,
      reglementData.tiers_saisie || null,
      reglementData.montant_brut || null,
      reglementData.base_retenue_source || null,
      reglementData.taux_retenue_source || null,
      reglementData.montant_retenue_source || null,
      reglementData.montant_net || null,
      reglementData.observations || null,
      userId,
    ], (err, result) => {
      if (err) {
