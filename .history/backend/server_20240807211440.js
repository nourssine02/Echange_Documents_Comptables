...
const OPENAI_API_KEY = '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';
...
app.post('/upload', upload.single('file'), async (req, res) => {
  ...
  try {
      ...
      console.error('Erreur lors de l\'extraction du texte ou de l\'appel à l\'API OpenAI:', error);
      res.status(500).send('Erreur lors de l\'extraction du texte ou de l\'appel à l\'API OpenAI.' , error.message);
  }
});
