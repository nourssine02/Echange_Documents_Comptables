...
app.get("/achats", authenticateToken, (req, res) => {
  ...
  if (req.user.role === 'client') {
    ...
    q += " WHERE entreprise_id = ?"; // Par exemple, l'entreprise du comptable
    params.push(req.user.entreprise_id); // Supposons que cette info est stockée dans le token
  }
  // Pour le rôle super_admin, pas de filtre additionnel
