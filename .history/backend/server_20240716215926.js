...
const verifyToken = (req, res, next) => {
  ...
  // Sécurité supplémentaire : s'assurer que token est bien une chaîne
      ...
      addBanques
        .then(() => {
          ...
          db.query(getRecipientQuery, [recipientRole], (recipientErr, recipientData) => {
            ...
            const recipientId = recipientData[0].id;
            const notificationMessage = `${req.user.identite} a mis à jour un Tier`;
            ...
            addNotification(recipientId, notificationMessage)
              .then(() => {
                ...
                db.commit((commitErr) => {
                  ...
                  res.status(200).json({ message: "Le tier, les banques et les notifications ont été mis à jour avec succès." });
                });
              })
              .catch((notifErr) => {
                console.error(`Erreur lors de l'ajout de la notification pour le ${recipientRole} :`, notifErr);
