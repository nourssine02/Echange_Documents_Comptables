...
app.post("/pointage", (req, res) => {
  ...
  let sql =
    "INSERT INTO `pointage_personnel`(`code_tiers`, `identite_tiers`, `type_paie`, `nbre_jours/H_travailles`, `nbre_jours/H_supp`, `nbre_jours/H_absence`, `nbre_jours/H_conges_annuel`, `nbre_jours/H_autres_conges`, `supplement_recu`, `avance_salaire`, `remboursement_prets`, `autres_deductions`, `observations`,) VALUES ?";
