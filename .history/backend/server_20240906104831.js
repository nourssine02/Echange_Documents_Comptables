...
app.get("/reglements_emis/:id", (req, res) => {
  ...
  db.query("SELECT * FROM reglements_emis WHERE id = ?", [reglementID])
    .then(([reglementRows]) => {
      ...
      // Paralléliser la récupération des payements et des pièces associées
      return Promise.all([
