...
app.post('/register', async (req, res) => {
    console.log("Requête reçue:", req.body); // Ajoutez cette ligne pour voir si la requête arrive
    const {
        code_entreprise,
        code_user,
        identite,
            ...
            db.query(
                ...
                (err, result) => {
                    if (err) {
                        ...
                        resolve(result); // On résout la promesse, mais ne renvoie pas le résultat.
                    }
                }
            );
        });
