...
app.post("/reglements_emis", verifyToken, (req, res) => {  
  ...
  // Validation pour les champs requis  
   if (!reglement || !reglement.montant_brut || !reglement.base_retenue_source ||  
    !reglement.taux_retenue_source || !reglement.montant_retenue_source ||   
  ...
  db.beginTransaction((err) => {  
    ...
    db.query(insertReglementQuery, [  
      ...
      console.log("Règlement reçu:", reglement);  
