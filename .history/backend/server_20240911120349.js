...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, 'uploads/'); // Chemin du répertoire où stocker les images
  },
...
app.post("/achats", upload.single('document_fichier'), verifyToken, (req, res) => {
  ...
  // Stocker le chemin de l'image uploadée
  ...
  db.query(q, values, (err, data) => {
    ...
    return res.status(200).json({ message: 'Achat added successfully', data });
