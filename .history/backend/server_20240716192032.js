...
//     addBanques
//       .then(() => {
//         // Ajout de la notification pour le comptable et pour le client
//         const notificationMessage = `${req.user.identite} a ajouté un Tier`;

//         // Récupérer le comptable / client
...
//             return res.status(500).json({ error: "Erreur lors de la récupération du comptable." });
//           }
...
//             // Ajouter la notification pour le client (exemple d'ajout pour le client, adapter selon votre logique)
...
//               db.query(notificationQuery, [clientId, notificationMessage], (notifClientErr, notifClientData) => {
//                 if (notifClientErr) {
//                   console.error("Erreur lors de l'ajout de la notification pour le client :", notifClientErr);
//                   return res.status(500).json({ error: "Erreur lors de l'ajout de la notification pour le client." });
//                 }

//                 return res.status(200).json({ message: "Le tier, les banques et les notifications ont été ajoutés avec succès." });
//               });
//             });
//           });
//         });
