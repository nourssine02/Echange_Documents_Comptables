...
app.post('/reset-password', (req, res) => {
  ...
  db.query(
    ...
    (err, results) => {
      ...
      db.query(
        'UPDATE utilisateurs SET password = ?, resetPasswordToken = NULL, resetPasswordExpires = NULL WHERE resetPasswordToken = ?',
...
// Route pour récupérer les entreprises en fonction du rôle de l'utilisateur
// app.get("/entreprises", verifyToken, (req, res) => {
//   if (req.user.role === 'comptable' || req.user.role === "super_admin") {
//     const q = "SELECT * FROM entreprises";
//     db.query(q, (err, data) => {
