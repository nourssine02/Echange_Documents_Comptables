...
app.post('/reglements_emis', verifyToken, (req, res) => {
  ...
  if (!reglementData) {
    return res.status(400).json({ error: 'Missing reglementData in reglement' });
  }
  ...
  db.beginTransaction((err) => {
    ...
    console.log('Insert Reglement Query:', insertReglementQuery);
    ...
    db.query(insertReglementQuery, [
      ...
      console.log('Reglement inserted with ID:', result.insertId);
