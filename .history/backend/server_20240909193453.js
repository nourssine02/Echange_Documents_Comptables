...
app.get("/achats/:id", (req, res) => {
  ...
  db.query(q, [achatID], (err, data) => {
    ...
    // Ajouter le chemin d'accès complet si le fichier est stocké localement
    if (data[0].document_fichier) {
      data[0].document_fichier = `http://localhost:5000/uploads/${data[0].document_fichier}`;
    }
