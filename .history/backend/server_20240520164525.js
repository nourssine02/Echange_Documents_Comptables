...
app.get('/entreprises', checkRole([roles.SUPER_ADMIN, roles.COMPTABLE]), (req, res) => {
  res.send('Liste des Entreprises');
});

app.get('/users', checkRole([roles.SUPER_ADMIN, roles.COMPTABLE]), (req, res) => {
  res.send('Liste des Utilisateurs');
});

app.get('/tiers', checkRole([roles.SUPER_ADMIN, roles.COMPTABLE]), (req, res) => {
  res.send('Liste des Tiers');
});

app.get('/achats', checkRole([roles.SUPER_ADMIN, roles.COMPTABLE, roles.CLIENT]), (req, res) => {
  res.send('Liste des Achats de Biens et de Services');
});
