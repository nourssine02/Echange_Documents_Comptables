...
const Entreprises = ({handleSidebarItemClick, isSidebarOpen }) => {
  ...
  const handleItemClick = () => {
    handleSidebarItemClick(); // Appeler la fonction pour garder le Sidebar ouvert
                ...
                {entreprises && entreprises.length > 0 ? (
                  <div className="table-responsive pt-3">
                    <table className="table table-sm table-hover">
                      ...
                      <tbody>
                        {filtered.map((ent) => (
                          <tr key={ent.id} onClick={handleItemClick}>
