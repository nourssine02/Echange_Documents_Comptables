...
const UpdateEntreprise = ({ isSidebarOpen }) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      setAlert({ type: "success", message: "Entreprise mis à jour avec succès." });
      Swal.fire({
        icon: "success",
        title: "Succès",
      ...
      console.log(err);
      setAlert({ type: "danger", message: "Une erreur est survenue lors de la mise à jour de l'entreprise." });
    }
