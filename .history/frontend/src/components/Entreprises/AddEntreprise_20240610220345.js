...
const AddEntreprise = ({isSidebarOpen}) => {
  ...
  const handleClick = async (e) => {
    ...
    if (!entreprise.code_entreprise) {
      formValid = false;
      newErrors.code_entreprise = "Code Entreprise est requis";
    } else {
    ...
    if (!entreprise.date_creation) {
      formValid = false;
      newErrors.date_creation = "Date De Creation est requis";
    } else {
    ...
    if (!entreprise.identite) {
      formValid = false;
      newErrors.identite = "Identite est requis";
    } else {
      newErrors.identite = "";
    }
    ...
    if (!entreprise.MF_CIN) {
      formValid = false;
      newErrors.MF_CIN = "MF/ CIN est requis";
    } else {
      newErrors.MF_CIN = "";
    }
    if (!entreprise.responsable) {
      formValid = false;
      newErrors.responsable = "Responsable est requis";
    } else {
    ...
    if (!entreprise.cnss) {
      formValid = false;
      newErrors.cnss = "CNSS est requis";
    } else {
      newErrors.cnss = "";
    }
    ...
    if (!entreprise.tel) {
      formValid = false;
      newErrors.tel = "Telephone est requis";
    } else {
      newErrors.tel = "";
    }
    ...
    if (!entreprise.adresse) {
      formValid = false;
      newErrors.adresse = "Adresse est requis";
    } else {
      newErrors.adresse = "";
    }
