...
const Entreprises = () => {
  ...
  const filtered = entreprises ? entreprises.filter((entreprise) => {
    const searchTermLower = searchTerm.toLowerCase();
    return (
      entreprise.code_entreprise.toLowerCase().includes(searchTermLower) ||
      new Date(entreprise.date_creation).toLocaleDateString().includes(searchTermLower) || 
      entreprise.identite.toLowerCase().includes(searchTermLower) ||
      entreprise.res.toLowerCase().includes(searchTermLower)
    ); 
  }) : [];
