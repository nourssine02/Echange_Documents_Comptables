              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="list-arrow" style={{ fontSize: "15px" }}>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>Date de Commande:</strong> {commande.date_commande}</li>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>N° de la Commande:</strong> {commande.num_commande}</li>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>Code Tiers:</strong> {commande.code_tiers}</li>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>Tiers à Saisir:</strong> {commande.tiers_saisie}</li>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>Montant de la Commande:</strong> {commande.montant_commande}</li>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>Date de Livraison Prévue:</strong> {commande.date_livraison_prevue}</li>
                    <li><strong style={{ color: "#118ab2", fontWeight: "bold" }}>Observations:</strong> {commande.observations}</li>
                    <li>
                  ...
                  <ul className="list-star" style={{ fontSize: "15px" }}>
                    {familles.map((famille, index) => (
                      <li key={index}>
                        <strong style={{ color: "#118ab2", fontWeight: "bold" }}>Famille:</strong> {famille.famille}, 
                        <strong style={{ color: "#118ab2", fontWeight: "bold" }}> Sous Famille:</strong> {famille.sous_famille}, 
                        <strong style={{ color: "#118ab2", fontWeight: "bold" }}> Article:</strong> {famille.article}, <br></br>
                        <strong style={{ color: "#118ab2", fontWeight: "bold" }}> Quantité:</strong> {famille.quantite},
                        <strong style={{ color: "#118ab2", fontWeight: "bold" }}> Prix:</strong> {famille.prix}
                      </li>
                    ))}
                  </ul>
                </div>
