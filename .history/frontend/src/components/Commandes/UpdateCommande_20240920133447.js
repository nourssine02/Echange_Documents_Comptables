...
const UpdateCommande = ({ isSidebarOpen }) => {
  ...
  // Fonction pour afficher la modale de sélection du tiers (si nécessaire)
  const handleModalShow = () => {
    // Logique pour ouvrir une modale
    console.log("Ouvrir la modale pour sélectionner le tiers.");
  };
              ...
              {familles.map((famille, index) => (
                <div key={index} className="mb-3 border p-3">
                  <div className="row">
                    ...
                    <div className="col-md-3">
                      <div className="form-group d-flex align-items-end mb-1">
                        <button
