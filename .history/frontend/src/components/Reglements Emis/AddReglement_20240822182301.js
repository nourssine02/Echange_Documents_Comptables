...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      case "montant_brut":
        error = value && !isNaN(value) ? "" : "Le montant brut est obligatoire et doit être un nombre valide";
        break;
      case "base_retenue_source":
        error = value && !isNaN(value) ? "" : "La base retenue à la source est obligatoire et doit être un nombre valide";
        break;
      case "taux_retenue_source":
        ...
        break;
      case "montant_net":
        error = value && !isNaN(value) ? "" : "Le montant net est obligatoire et doit être un nombre valide";
        break;
      default:
        error = value ? "" : `Le champ ${name} est obligatoire`;
        break;
    }
