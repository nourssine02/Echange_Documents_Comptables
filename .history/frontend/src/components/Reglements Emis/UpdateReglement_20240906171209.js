...
const UpdateReglement = ({ isSidebarOpen }) => {
  ...
  console.log(URL.createObjectURL(piece.document_fichier));
  ...
  {piece.document_fichier && (
    <img
      src={URL.createObjectURL(piece.document_fichier)}
      ...
      onClick={() => openImageViewer(URL.createObjectURL(piece.document_fichier))}
    />
  )}
</div>
