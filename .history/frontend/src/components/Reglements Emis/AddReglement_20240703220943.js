    ...
    Object.keys(reglement).forEach((key) => {
      ...
      switch (key) {
        case "code_tiers":
          ...
          break;
        case "tiers_saisie":
          error = value ? "" : "Tiers saisi est obligatoire";
          break;
        case "montant_brut":
          error = value ? "" : "Montant brut est obligatoire";
          break;
        case "base_retenue_source":
          error = value ? "" : "Base retenue à la source est obligatoire";
          break;
        case "taux_retenue_source":
          error = value ? "" : "Taux retenue à la source est obligatoire";
          break;
        case "montant_retenue_source":
          error = value ? "" : "Montant retenue à la source est obligatoire";
          break;
        case "montant_net":
          error = value ? "" : "Montant net est obligatoire";
          break;
        case "observations":
          error = value ? "" : "Observations sont obligatoires";
          break;
        case "modalite":
          error = value ? "" : "Modalité est obligatoire";
          break;
        case "num":
          error = value ? "" : "Numéro est obligatoire";
          break;
        case "banque":
          error = value ? "" : "Banque est obligatoire";
          break;
        case "date_echeance":
          error = value ? "" : "Date d'échéance est obligatoire";
          break;
        case "num_piece_a_regler":
          error = value ? "" : "Numéro de la pièce est obligatoire";
          break;
        case "date_piece_a_regler":
          error = value ? "" : "Date de la pièce est obligatoire";
          break;
        case "montant_piece_a_regler":
          error = value ? "" : "Montant de la pièce est obligatoire";
          break;
        case "document_fichier":
          error = value ? "" : "Document (fichier) est obligatoire";
          break;
        default:
          break;
      }
