  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Vérifiez que chaque champ est bien présent avant de les utiliser
        setReglement({
          date_saisie: reglement.date_saisie || new Date().toISOString().split("T")[0],
          date_saisie: reglement.date_saisie ? data.date_saisie.split('T')[0] : "",
