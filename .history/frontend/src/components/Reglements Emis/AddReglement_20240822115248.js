...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const initialReglementState = {
    ...
    tierId: "", // Pour stocker l'ID du tier sélectionné
    code_tiers: "", // Pour stocker le code_tiers du tier sélectionné  
    tiers_saisie: "",
    montant_brut: "",
    base_retenue_source: "",
    taux_retenue_source: "",
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    {errors.montant_net && <small className="text-danger">{errors.montant_brut}</small>}
