...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const validateForm = () => {  
    const newErrors = {};  
    if (!reglement.montant_brut) newErrors.montant_brut = "Le montant brut est obligatoire.";  
    if (!reglement.base_retenue_source) newErrors.base_retenue_source = "La base retenue à la source est obligatoire.";  
    if (!reglement.taux_retenue_source) newErrors.taux_retenue_source = "Le taux retenue à la source est obligatoire.";  
    if (!reglement.montant_retenue_source) newErrors.montant_retenue_source = "Le montant retenue à la source est obligatoire.";  
    if (!reglement.montant_net) newErrors.montant_net = "Le montant net est obligatoire.";  
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    {errors.montant_retenue_source && (
                      <span className="text-danger">                        {errors.montant_retenue_source}
                      </span>
                    )}
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    {text-dangers.montant_net && (
                      <span className="text-danger">                        {errors.montant_net}
                      </span>
                    )}
                  </div>
                </div>
