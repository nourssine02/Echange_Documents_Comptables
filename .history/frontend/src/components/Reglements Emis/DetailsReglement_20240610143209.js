                ...
                <ul className="list-unstyled">
                  {payements.map((payement, index) => (
                    <li key={index}>
                      ...
                      <strong style={{ color: "#118ab2", fontWeight: "bold" }}> Banque:</strong> {payement.banque}, <br />
                ...
                <ul className="list-unstyled">
                  {pieces.map((piece, index) => (
                    <li key={index}>
                      ...
                      <strong style={{ color: "#118ab2", fontWeight: "bold" }}> Montant de la Pièce à Régler:</strong> {piece.montant_piece_a_regler}, <br />
