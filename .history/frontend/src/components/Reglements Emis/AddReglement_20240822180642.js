...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  <Select
    ...
    value={banques.find((banque) => banque.name === payement.banque) 
      ? { value: payement.banque, label: payement.banque }
      : null}
    onChange={(selectedOption) => handleChangePayement({ target: { name: "banque", value: selectedOption.value } }, index)}
