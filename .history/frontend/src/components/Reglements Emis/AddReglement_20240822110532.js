  ...
  const handleSubmit = async (e) => {
    ...
    if (!hasErrors) {
      ...
      pieces.forEach((piece, index) => {
        ...
        if (piece.document_fichier) formData.append(`pieces[${index}][document_fichier]`, piece.document_fichier);
      });

      try {
        await axiosWithAuth().post("/reglements_emis", formData);
