...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const validateForm = () => {  
    ...
    if (!reglement.montant_retenue_source) newErrors.montant_brut = "Le montant brut est obligatoire.";  
    if (!reglement.montant_net) newErrors.montant_brut = "Le montant brut est obligatoire.";  
