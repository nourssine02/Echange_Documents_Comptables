...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/reglements_emis", formData, {
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    {errors.montant_brut && (
                      <span className="text-danger">{errors.montant_brut}</span>
                    )}
                  </div>
                </div>
                <div className="col-md-4">
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    {text - dangers.montant_net && (
                      <span className="text-danger"> {errors.montant_net}</span>
                    )}
                  </div>
                </div>
                <div className="col-md-4">
