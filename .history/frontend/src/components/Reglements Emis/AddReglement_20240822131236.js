...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!hasErrors) {
      ...
      // Ajout des pièces et des fichiers associés
      ...
      try {
        ...
        await axiosWithAuth().post("http://localhost:5000/reglements_emis", formData);
        ...
        Swal.fire("Succès", "Règlement ajouté avec succès", "success");
        setReglement(initialReglementState);
        console.log(setReglement(initialReglementState));
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    />
                    {errors.date_saisie && <small className="text-danger">{errors.montant_brut}</small>}
