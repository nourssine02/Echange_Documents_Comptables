...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const [showTiersSaisie, setShowTiersSaisie] = useState(true); // Ajout de l'état pour gérer la visibilité de tiers_saisie
  ...
  const handleChange = (e) => {
    ...
    setReglement((prevReglement) => {
      ...
      if (name === 'code_tiers') {
        fetchBanques(value);
        setShowTiersSaisie(value === ''); // Show tiers_saisie if no code_tiers is selected
