      ...
      case "pieces":
        return (
          <div>
            ...
            <br></br>
            <button type="button" className="btn btn-success btn-sm" onClick={addPiece}>
              Ajouter une pièce
            </button>
          </div> 
        ); 
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          <h2>Ajouter un règlement ({type === "reglements_emis" ? "Émis" : "Reçus"})</h2>
          <form onSubmit={handleSubmit}>
            ...
            <div className="tabs">
              <button
                type="button"
                style={{color: "black"}}
                className={`btn ${activeTab === "payements" ? "btn-rounded-dark" : "btn-rounded-light"}`}
              ...
              <button
                type="button"
                style={{color: "black"}}
                className={`btn ${activeTab === "pieces" ? "btn-dark" : "btn-light"}`}
