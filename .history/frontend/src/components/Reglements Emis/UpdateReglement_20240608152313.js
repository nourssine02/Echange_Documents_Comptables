...
const UpdateReglement = ({ isSidebarOpen }) => {
      ...
      case "payements":
        return (
          <div>
            ...
            <button type="button" className="btn btn-primary" onClick={addPayement}>
              Ajouter Paiement
            </button>
          </div>
        );
  ...
  return (
    <div className="AddReglement-container">
      <h2 className="text-center">Mettre à jour le règlement émis</h2>
