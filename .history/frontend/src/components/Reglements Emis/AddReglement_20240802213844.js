...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  <div>
    <p>Fichier actuel: {piece.document_fichier.name || piece.document_fichier}</p>
    <img
      src={piece.document_fichier instanceof File ? URL.createObjectURL(piece.document_fichier) : `path_to_your_server/${piece.document_fichier}`}
      alt="Document"
