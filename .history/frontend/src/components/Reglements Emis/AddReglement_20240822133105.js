...
const AddReglement = ({ isSidebarOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosWithAuth().post("/reglements", formData, {
      ...
      Swal.fire({
        ...
        navigate(`/reglement/${response.data._id}`);
      });
    } catch (error) {
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    />
                    {errors.date_saisie && <small className="text-danger">{errors.date_saisie}</small>}
