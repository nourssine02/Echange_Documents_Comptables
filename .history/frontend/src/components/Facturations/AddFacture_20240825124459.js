    ...
    try {
      ...
      while (status === "running" || status === "notStarted") {
        ...
        if (status === "succeeded") {
          ...
          const montantHT = fields.SubTotal?.valueNumber || fields["Total HT"]?.valueNumber || "";
          const tva = fields.TotalTax?.valueNumber || fields["Total TVA"]?.valueNumber || "";
          ...
          const montantTotal = fields.InvoiceTotal?.text || fields["Net A Payer"]?.text || fields["Total TTC"]?.text || "";
          ...
          setFacture({
            ...
            TVA_facture: tva, 
            FODEC_sur_facture: fodec,  // Ajouter la logique pour FODEC si disponible
...
/>
  ...
  name="num_facture"
  onChange={handleChange}
  value={facture.num_facture || ""}  // Toujours une chaîne vide si non défini
