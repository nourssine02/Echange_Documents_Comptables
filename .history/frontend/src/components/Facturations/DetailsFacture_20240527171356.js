              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="list-star" style={{ fontSize: "14px" }}>
                    ...
                    <li><strong style={{ color: "darkblue", fontWeight: "bold" }}  >TVA sur la Facture:</strong> {facture.TVA_facture}</li>
                    <li><strong style={{ color: "darkblue", fontWeight: "bold" }}  >Timbre sur la Facture:</strong> {facture.timbre_facture}</li>
                    <li><strong style={{ color: "darkblue", fontWeight: "bold" }}  >Autre montant de la Facture:</strong> {facture.autre_montant_facture}</li>
                    <li><strong style={{ color: "darkblue", fontWeight: "bold" }}  >Montant Total de la Facture:</strong> {facture.montant_total_facture}</li>
                    <li><strong style={{ color: "darkblue", fontWeight: "bold" }}  >Observations:</strong> {facture.observations}</li>
                    <li>
                      <strong style={{ color: "darkblue", fontWeight: "bold" }}  >Document / Fichier à Insérer:</strong>{" "}
                  ...
                  <ul className="list-star" style={{ fontSize: "14px" }}>
                    {familles.map((famille, index) => (
                      <li key={index}>
                        ...
                        <strong style={{ color: "darkgreen", fontWeight: "bold" }}> Article:</strong> {famille.article}, <br></br>
