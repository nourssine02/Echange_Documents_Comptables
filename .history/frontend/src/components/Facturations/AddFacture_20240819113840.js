...
// Fonction pour structurer les informations avec Hugging Face
const structureInfoWithAI = async (extractedText) => {
  try {
    const response = await hf.textClassification({
      model: "distilbert-base-uncased", // Choisissez un modèle NLP sur Hugging Face
      inputs: extractedText,
    });

    // Simulate extracted information from the response
    const aiData = {
      date_facture: "2023-08-17",
      num_facture: "FCT12345",
      montant_HT_facture: "5000",
      FODEC_sur_facture: "0",
      TVA_facture: "500",
      timbre_facture: "5",
      montant_total_facture: "5505",
    };
