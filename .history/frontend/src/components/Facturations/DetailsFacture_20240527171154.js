              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="list-star" style={{ fontSize: "14px" }}>
                    ...
                    <li><strong>Code Tiers:</strong> {facture.code_tiers}</li>
                    <li><strong>Tiers à Saisir:</strong> {facture.tiers_saisie}</li>
                    <li><strong>Référence de la Livraison:</strong> {facture.reference_livraison}</li>
                    <li><strong>Montant HT de la Facture:</strong> {facture.montant_HT_facture}</li>
                    <li><strong>FODEC sur la Facture:</strong> {facture.FODEC_sur_facture}</li>
