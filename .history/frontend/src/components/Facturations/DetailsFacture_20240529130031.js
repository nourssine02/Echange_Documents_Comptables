              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="list-star" style={{ fontSize: "16px" }}>
                    <li> 
                      <strong
                        style={{ color: "#b5179e", fontWeight: "bold" }}
                      >
                        Date de la Facture:
                      </strong>{" "}
                    ...
                    <li>
                      <strong
                        style={{ color: "#61a5c2", fontWeight: "bold" }}
                      >
                        N° de la Facture:
                      </strong>{" "}
                      {facture.num_facture}
                    ...
                    <li>
                      <strong
                        style={{ color: "#89c2d9", fontWeight: "bold" }}
                      >
                        Code Tiers:
                      </strong>{" "}
                      {facture.code_tiers}
                    ...
                    <li>
                      <strong
                        style={{ color: "#dc0073", fontWeight: "bold" }}
                      >
                        Tiers à Saisir:
                      </strong>{" "}
                    ...
                    <li>
                      <strong
                        style={{ color: "#d81159", fontWeight: "bold" }}
                      >
                  ...
                  <ul className="list-star" style={{ fontSize: "1px" }}>
