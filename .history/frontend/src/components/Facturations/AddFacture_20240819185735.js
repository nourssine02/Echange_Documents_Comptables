  ...
  const structureInfoWithAI = async (extractedText) => {
    try {
      ...
      response.forEach((entity) => {
        console.log("Entité:", entity); // Vérifiez la sortie dans la console
        switch (entity.entity_group) {
          ...
          case "NUMBER":
            ...
            break;
          case "SUBTOTAL":
            aiData.montant_HT_facture = entity.word.replace("DT", "").trim();
            break;
          case "TAX":
            aiData.TVA_facture = entity.word.replace("DT", "").trim();
            break;
          case "TOTAL":
            aiData.montant_total_facture = entity.word.replace("DT", "").trim();
            break;
          default:
            console.log("Entité inconnue :", entity);
        }
      });
