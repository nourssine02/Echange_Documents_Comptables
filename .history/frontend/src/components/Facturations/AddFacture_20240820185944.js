  ...
  const analyzeInvoiceWithAzure = async (file) => {
    ...
    try {
      const response = await axios.post(
        "https://form-recognizer-service.cognitiveservices.azure.com/formrecognizer/v2.1/prebuilt/invoice/analyze?includeTextDetails=true", // Remplacez par votre endpoint Azure
        formData,
        {
          headers: {
