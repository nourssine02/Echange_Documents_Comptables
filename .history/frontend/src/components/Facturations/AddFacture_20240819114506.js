...
const structureInfoWithAI = async (extractedText) => {
  try {
    const response = await hf.tokenClassification({
      model: "dslim/bert-base-NER", // Utilisation d'un modèle NER pour extraire les entités
    ...
    response.forEach((entity) => {
      ...
      // Ajoutez d'autres règles pour extraire les champs restants si nécessaire
    });
