  ...
  try {
    ...
    response.forEach((entity) => {
      if (entity.entity_group === "DATE") {
        ...
        aiData.montant_total_facture = entity.word.replace("DT", "").trim(); // Montant total
      } else if (entity.entity_group === "SUBTOTAL") {
        aiData.montant_HT_facture = entity.word.replace("DT", "").trim(); // Montant HT
      }
      // Ajoutez d'autres entités si nécessaire, comme TVA, FODEC, etc.
    });
