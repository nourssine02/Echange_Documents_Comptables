        ...
        if (status === "succeeded") {
          const fields =
            ...
            setFacture({
              ...
              montant_HT_facture: fields["SubTotal"]?.valueNumber || "", // Vérifiez si le champ dans l'API est "SubTotal"
              TVA_facture: fields["TotalTax"]?.valueNumber || "", // Vérifiez si le champ est "TotalTax"
              FODEC_sur_facture: fields["FODEC"]?.valueNumber || "",
              timbre_facture: fields["Timbre"]?.valueNumber || "",
              montant_total_facture: fields["InvoiceTotal"]?.valueNumber || "", // Peut-être "InvoiceTotal" selon la structure API
            });
