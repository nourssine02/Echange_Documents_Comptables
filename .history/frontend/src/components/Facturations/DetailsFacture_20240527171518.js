              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <ul className="list-star" style={{ fontSize: "14px" }}>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }} >Date de la Facture:</strong> {facture.date_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }} >N° de la Facture:</strong> {facture.num_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }} >Code Tiers:</strong> {facture.code_tiers}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }} >Tiers à Saisir:</strong> {facture.tiers_saisie}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }} >Référence de la Livraison:</strong> {facture.reference_livraison}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >Montant HT de la Facture:</strong> {facture.montant_HT_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >FODEC sur la Facture:</strong> {facture.FODEC_sur_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >TVA sur la Facture:</strong> {facture.TVA_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >Timbre sur la Facture:</strong> {facture.timbre_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >Autre montant de la Facture:</strong> {facture.autre_montant_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >Montant Total de la Facture:</strong> {facture.montant_total_facture}</li>
                    <li><strong style={{ color: "darkgreen", fontWeight: "bold" }}  >Observations:</strong> {facture.observations}</li>
                    <li>
                      <strong style={{ color: "darkgreen", fontWeight: "bold" }}  >Document / Fichier à Insérer:</strong>{" "}
                  ...
                  <ul className="list-star" style={{ fontSize: "14px" }}>
                    {familles.map((famille, index) => (
                      <li key={index}>
                        ...
                        <strong style={{ color: "darkgreen", fontWeight: "bold" }}> Prix:</strong> {famille.prix}
                      </li>
                    ))}
                  </ul>
                  {/* fin */}
