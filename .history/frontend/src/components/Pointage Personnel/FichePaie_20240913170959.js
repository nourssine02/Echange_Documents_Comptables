...
const FichePaie = ({ isSidebarOpen }) => {
  ...
  const generatePDF = (fiche) => {
    ...
    doc.text(`Nbres Jours/H d' Autres Congés: ${fiche["nbre_jours/H_autres_conges"]}`, 20, 100);
    doc.text(`Supplement Reçu: ${fiche.supplement_recu}`, 20, 110);
    doc.text(`Avances sur Salaires: ${fiche.avance_salaire}`, 20, 120);
    doc.text(`Remboursement de Prets: ${fiche.remboursement_prets}`, 20, 130);
    doc.text(`Autres Déductions: ${fiche.autres_deductions}`, 20, 140);
  ...
  <tr>
    ...
    <th>Type de Paie</th>
    <th>
      Nbres Jours/H<br />Travaillés
    </th>
    <th>
      Nbres Jours/H<br />Supp
    </th>
    <th>
      Nbres Jours/H<br />d'Absence
    </th>
    <th>
      Nbres Jours/H<br />de Congé Annuel
    </th>
    <th>
      Nbres Jours/H<br />d' Autres Congés
    </th>
