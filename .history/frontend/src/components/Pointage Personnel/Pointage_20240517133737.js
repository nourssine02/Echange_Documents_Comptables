        ...
        <div className="container mt-5">
            ...
            <form onSubmit={handleSubmit} className="mb-5">
                ...
                <div className="mb-3">
                    ...
                    <input type="text" name="observations" value={formData.observations} onChange={handleChange} className="form-control" />
                </div>
                <button type="submit" className="btn btn-primary">Submit</button>
            </form>

            <div className="mb-4">
                <label>Search Code Tiers:</label>
                <input type="text" value={searchCodeTiers} onChange={handleSearchChange} className="form-control" />
                <button onClick={fetchRecords} className="btn btn-primary mt-2">Search</button>
            </div>
