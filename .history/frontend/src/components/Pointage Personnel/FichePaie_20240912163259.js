...
const FichePaie = ({ isSidebarOpen }) => {
  ...
  const handleDownload = (selectedOption, fiche) => {
  ...
  const downloadOptions = [
    { value: "pdf", label: "Télécharger en PDF" },
    { value: "excel", label: "Télécharger en Excel" },
    { value: "csv", label: "Télécharger en CSV" },
  ];
              ...
              <table className="table table-hover">
                ...
                <tbody>
                  {fiches.map((fiche) => (
                    <tr key={fiche.id}>
                      <td>
                        {new Date(fiche.date_de_saisie).toLocaleDateString()}
                      </td>
                      ...
                      <td>
                        <Select
                          ...
                          onChange={(selectedOption) =>
                            handleDownload(selectedOption, fiche)
                          }
                        />
                      </td>
                    </tr>
                ...
                (fiche) =>
                  detailsVisible[fiche.id] && (
                    ...
                    >
                      ...
                      <div style={{ marginRight: "40px" }}>
                        <strong>Remboursement Divers:</strong>{" "}
                        {fiche.remboursement_divers}
                      </div>
                      <div style={{ marginRight: "40px" }}>
