...
const UploadFile = ({ isSidebarOpen }) => {
  ...
  const expectedColumns = ["code_tiers", "identite_tiers", "Email", "Date", "Heures"];
  ...
  const handleUpload = async () => {
    ...
    if (!isValidCSV) {
      Swal.fire({
        ...
        footer: '<a href="/mnt/data/FICHIER_DE_POINTAGE.csv" download>Télécharger un exemple de fichier CSV</a>'
      });
      return;
    }
