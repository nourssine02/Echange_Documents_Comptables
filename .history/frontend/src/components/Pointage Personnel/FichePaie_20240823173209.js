              ...
              {fiches.map((fiche) => (
                detailsVisible[fiche.id] && (
                  <div key={fiche.id} className="details-section mt-3">
                    <div className="ml-3"><strong>Sommes Rejetées:</strong> {fiche.sommes_rejetees}</div>
                    <div className="ml-3"><strong>Remboursement Divers:</strong> {fiche.remboursement_divers}</div>
