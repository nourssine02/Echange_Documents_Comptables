                  ...
                  detailsVisible[fiche.id] && (
                    ...
                    >
                       <div style={{ marginRight: "40px" }}>
                        <strong>Supplement Reçu:</strong> {fiche.supplement_recus}
                      </div>
                      <div style={{ marginRight: "40px" }}>
                        <strong>Avances sur Salaires:</strong> {fiche.sommes_rejetees}
                      </div>
                      <div style={{ marginRight: "40px" }}>
                        <strong>Remboursement de Prets:</strong> {fiche.remboursement_divers}
                      </div>
                      <div style={{ marginRight: "40px" }}>
                        <strong>Autres Déductions:</strong> {fiche.autre_deduction}
                      </div>
                      <div style={{ marginRight: "40px" }}>
