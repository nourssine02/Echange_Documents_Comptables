  ...
  return (
    <div className="main-panel">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <Button onClick={() => generatePDF(fiche)} className="btn btn-success mb-2" block>
            Télécharger en PDF
          </Button>
          <br></br>
          <Button onClick={() => downloadExcel(fiche)} className="btn btn-primary mb-2" block>
            Télécharger en Excel
          </Button>
          <Button onClick={() => downloadCSV(fiche)} className="btn btn-info mb-2" block>
            Télécharger en CSV
          </Button>
        </Modal.Body>
        <Modal.Footer>
