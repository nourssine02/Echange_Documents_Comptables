                ...
                <tbody>
                  {slips.map((slip) => (
                    <tr key={slip.id}>
                      ...
                      <td>
                                <button onClick={() => generatePDF(slip)} className="btn btn-success">Download</button>
                                <button onClick={() => generatePDF(slip)} className="btn btn-success">Import Excel</button>
                            </td>
                    </tr>
                  ))}
                </tbody>
