                ...
                <tbody>
                  {fiches.map((fiche) => (
                    <tr key={fiche.id}>
                      ...
                      <td>
                        <button onClick={() => generatePDF(fiche)} className="btn btn-success">Download</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              {fiches.map((fiche) => (
                detailsVisible[fiche.id] && (
                  <div key={fiche.id} className="details-section mt-3">
                    <strong>Sommes Rejetées:</strong> {fiche.sommes_rejetees} <br />
                    <strong>Remboursement Divers:</strong> {fiche.remboursement_divers} <br />
