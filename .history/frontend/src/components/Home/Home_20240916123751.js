        ...
        <div className="row">
          <div className="col-lg-12 grid-margin stretch-card">
            ...
            <div className="col-lg-6 grid-margin stretch-card">
              <div className="card">
                <div className="card-body"><div className="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <h4 className="card-title">Bar chart</h4>
                  <canvas id="barChart" width="538" height="269" style={{"display": "block", "width": "538px", "height": "269px"}} className="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
          </div>
