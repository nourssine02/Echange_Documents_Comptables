      ...
      <div className="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul className="navbar-nav navbar-nav-right">
          <li className="nav-item dropdown">
            <button className="nav-link count-indicator dropdown-toggle btn btn-default" id="notificationDropdown" onClick={toggleNotificationDropdown}>
                ...
                notifications.map((notification) => (
                  <div className="dropdown-item" key={notification.id}>
                    ...
                    <p className="text-muted">
                      ...
                      <button className="btn btn-link btn-sm text-danger" onClick={() => removeNotification(notification.id)}>
          ...
          <li className="nav-item nav-profile dropdown">
            <button className="nav-link btn btn-default dropdown-toggle" id="profileDropdown" onClick={toggleSettingsDropdown}>
              <img src="assets/images/faces/face1.jpg" alt="profile" />
            </button>
            <div className={`dropdown-menu dropdown-menu-right navbar-dropdown ${isSettingsDropdownOpen ? "show" : ""}`} aria-labelledby="profileDropdown">
