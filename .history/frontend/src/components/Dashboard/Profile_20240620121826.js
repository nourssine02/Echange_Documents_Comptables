                    ...
                    <MDBCol md="8">
                      <MDBCardBody className="p-4">
                        <form onSubmit={handleSubmit}>
                          ...
                          <MDBRow className="pt-1">                              <MDBInput label="Code Utilisateur" name="code_user" value={formData.code_user} onChange={handleChange} />

                            <MDBCol size="6" className="mb-3">
                            </MDBCol>
                            <MDBCol size="6" className="mb-3">
                              <MDBInput label="Code Entreprise" name="code_entreprise" value={formData.code_entreprise} onChange={handleChange} />
                            </MDBCol>
                          </MDBRow>
                          <MDBRow className="pt-1">
                            <MDBCol size="6" className="mb-3">
                              <MDBInput label="Email" name="email" value={formData.email} onChange={handleChange} />
                            </MDBCol>
                            <MDBCol size="6" className="mb-3">
                              <MDBInput label="Telephone" name="tel" value={formData.tel} onChange={handleChange} />
                            </MDBCol>
                          </MDBRow>
                          <MDBRow className="pt-1">
                            <MDBCol size="6" className="mb-3">
                              <MDBInput label="Position" name="position" value={formData.position} onChange={handleChange} />
                            </MDBCol>
                            <MDBCol size="6" className="mb-3">
                              <MDBInput label="Role" name="role" value={formData.role} onChange={handleChange} />
                            </MDBCol>
                          </MDBRow>
