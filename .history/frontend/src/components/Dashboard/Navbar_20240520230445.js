      ...
      <div className="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul className="navbar-nav navbar-nav-right">
          <li className="nav-item dropdown">
            <button className="nav-link count-indicator dropdown-toggle btn btn-light" id="notificationDropdown" data-toggle="dropdown" onClick={toggleNotificationDropdown}>
          ...
          <li className={`nav-item nav-settings d-none d-lg-flex dropdown ${isSettingsDropdownOpen ? "show" : ""}`}>
            <button className="nav-link  btn btn-light" onClick={toggleSettingsDropdown}>
