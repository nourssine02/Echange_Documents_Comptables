    ...
    <nav className="sidebar sidebar-offcanvas" id="sidebar">
      <ul className="nav" style={{ marginLeft: "10px" }}>
        ...
        <li className="nav-item">
          <a className="nav-link" href="/tiers">
           <i className="bi bi-person-add menu-icon"></i>
            <span className="menu-title"  style={{fontSize: '15px'}}>Liste des Tiers</span>
          </a>
        </li>
        ...
        <li className="nav-item" >
          <a className="nav-link" href="/achats" >
           <i className="bi bi-bag menu-icon"></i>
            <span className="menu-title" style={{fontSize: '14px'}} >Liste des Achats de <br></br> Biens et de Services </span>
          </a>
        </li>
        ...
        <li className="nav-item" >
          ...
          <span className="menu-title" style={{fontSize: '14px'}} >Liste des Reglements <br></br>Emis</span>
          </a>
        </li>
        ...
        <li className="nav-item" >
          ...
          <span className="menu-title" style={{fontSize: '14px'}} >Liste des Commandes</span>
          </a>
        </li>
        ...
        <li className="nav-item" >
          ...
          <span className="menu-title" style={{fontSize: '14px'}} >Liste des Livraisons</span>
          </a>
        </li>
        ...
        <li className="nav-item " >
          ...
          <span className="menu-title" style={{fontSize: '14px'}} >Liste des Facturations</span>
          </a>
        </li>
        ...
        <li className="nav-item" >
          ...
          <span className="menu-title" style={{fontSize: '14px'}} >Liste des Reglements <br></br>Reçus</span>
          </a>
        </li>
        ...
        <li className="nav-item" >
          ...
          <span className="menu-title" style={{fontSize: '14px'}} >Liste des Versements</span>
          </a>
        </li>
