...
const Sidebar = ({ isSidebarOpen, toggleSidebar, handleSidebarItemClick }) => {
  ...
  return (
    <nav className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
      <ul className="nav" style={{ marginLeft: "10px" , marginTop: "70px" }}>
        ...
        <li className="nav-item ">
          <a className="nav-link" href="/entreprises" onClick={handleSidebarItemClick}>
        ...
        <li className="nav-item">
          <a className="nav-link" href="/users" onClick={handleSidebarItemClick}>
        ...
        <li className="nav-item">
          <a className="nav-link" href="/tiers" onClick={handleSidebarItemClick}>
