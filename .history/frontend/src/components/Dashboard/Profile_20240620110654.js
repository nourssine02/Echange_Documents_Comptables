                ...
                <MDBCard className="mb-3" style={{ borderRadius: '.5rem' }}>
                  <MDBRow className="g-0">
                    <MDBCol md="4" className="text-center text-white"
                      ...
                      <MDBTypography tag="h5">{user.identite}</MDBTypography>
                      ...
                      <MDBCardBody className="p-4">
                        ...
                        <MDBRow className="pt-1">
                          <MDBCol size="6" className="mb-3">
                            <MDBTypography tag="h6">Code Utilisateur</MDBTypography>
                            <MDBCardText className="text-muted">{user.code_user}</MDBCardText>
                          </MDBCol>
                          <MDBCol size="6" className="mb-3">
                            <MDBTypography tag="h6">Code Entreprise</MDBTypography>
                            <MDBCardText className="text-muted">{user.code_entreprise}</MDBCardText>
                          </MDBCol>
                        </MDBRow>
                        <MDBRow className="pt-1">
                          <MDBCol size="6" className="mb-3">
                        ...
                        <MDBRow className="pt-1">
                          <MDBCol size="6" className="mb-3">
                            ...
                            <MDBCardText className="text-muted">{user.position}</MDBCardText>
                          </MDBCol>
                          <MDBCol size="6" className="mb-3">
