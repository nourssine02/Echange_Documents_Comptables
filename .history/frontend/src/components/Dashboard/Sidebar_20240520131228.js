    ...
    <nav className="sidebar sidebar-offcanvas" id="sidebar">
      <ul className="nav" style={{ marginLeft: "10px" }}>
          ...
          <>
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/documents_direction">
                    <i className="bi bi-file-slides menu-icon"></i>
                    <span className="menu-title" style={{ fontSize: "14px" }}>
              ...
              <>
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/documents_comptabilite">
                    <i className="bi bi-files menu-icon"></i>
                    <span className="menu-title" style={{ fontSize: "14px" }}>
                      Liste des Documents <br></br>Comptabilité
                    </span>
                  </a>
                </li>
              </>
            ...
            {/* Afficher le tableau de bord pour le client */}
            {isClient && (
              <>
                <li className="nav-item">
                  <Link className="nav-link" to="/home">
