...
const Navbar = () => {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(false); // Nouvel état pour le Sidebar
  ...
  return (
    ...
    <Sidebar isSidebarOpen={isSidebarOpen} toggleSidebar={toggleSidebar} handleSidebarItemClick={handleSidebarItemClick} />
