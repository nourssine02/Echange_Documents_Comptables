...
import axiosInstance from "../api/axiosInstance"; // Assurez-vous que vous importez axiosInstance correctement

const AddTier = ({ isSidebarOpen, user }) => { // Assurez-vous que vous passez user en tant que prop
