...
const AddTier = ({ isSidebarOpen }) => {
  ...
  const [paysOptions] = useState([
    ...
    { value: "united arab emirates", label: "France" },
  ]);
  ...
  const handleClick = async (e) => {
    ...
    if (!hasErrors) {
      ...
      try {
        ...
        if (user && (user.role === "comptable" || user.role === "client")) {
          // Add notification
          const notificationMessage = `${user.identite} a ajouté un tier`;
          ...
          <div className="card-body">
            ...
            <form className="forms-sample">
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      disabled={tier.type !== "autre"} // Disable if tier.type is not "autre"
                    />
                  </div>
              ...
              <div className="d-flex justify-content-center">
                <button className="btn btn-primary mr-2" onClick={handleClick} type="submit">
                  Ajouter
                </button>
