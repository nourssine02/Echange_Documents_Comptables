...
const EtatVersementParPeriode = ({ isSidebarOpen }) => {
  ...
  const fetchVersement = async () => {
    ...
    try {
      const response = await axios.get("http://localhost:5000/etat-versement-par-periode", {
          ...
          <div className="col-lg-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h3 className="text-center">Etat de versement par période</h3>
                <br />
                <br />
                <br />
                ...
                <h3 className="text-center">
                  Total des versements: {totalVersement} DZD
                </h3>
              </div>
            </div>
          </div>
