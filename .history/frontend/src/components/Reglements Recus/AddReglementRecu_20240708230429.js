...
const AddReglementRecu = ({isSidebarOpen}) => {
    ...
    <div className="main-panel">
      ...
      <div className="card">
          <div className="card-body">
            <h1 className="text-center">Ajouter un Règlement Reçus</h1>
            <br />
  ...
  name="date_facture"
  value={facture.date_facture ? facture.date_facture.split("T")[0] : ""}
  readOnly
/>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <span style={{fontSize: "20px" , marginLeft: "18px" }}>DT</span>
                    </div>
                  </div>
                </div>
