...
import "../Reglements Emis/AddReglement.css";
...
const LignesDeFacture = ({ factures = [], setFactures, factureOptions, handleChangeFacture, loadingFacture, addFacture, removeFacture }) => (
  <>
