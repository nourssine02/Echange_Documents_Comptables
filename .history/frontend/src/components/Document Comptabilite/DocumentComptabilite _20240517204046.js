...
const DocumentComptabilite = () => {
  ...
  const VoirDocument = (id) => {
    // Récupérer l'URL de l'image en fonction de l'ID du document
    const document = documents.find((doc) => doc.document_fichier === id);
    const imageUrl = document && document.image_url;
