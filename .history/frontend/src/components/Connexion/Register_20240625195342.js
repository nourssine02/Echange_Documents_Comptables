...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    } else if (!/^\d{8}$/.test(userData.tel)) {
      formValid = false;
      newErrors.tel = 'Telephone must be 8 digits';
    } else {
      newErrors.tel = '';
    }
    ...
    } else if (userData.mot_de_passe.length < 4) {
      formValid = false;
      newErrors.mot_de_passe = 'Mot de Passe must be at least 4 characters';
    } else {
    ...
    const existingIdentite = identites.find((code) => code.identite === userData.identite);
    if (existingIdentite) {
                ...
                <form className="pt-3" onSubmit={handleSubmit}>
                  ...
                  <div className="form-row">
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        />
                        {errors.code_user && <div className="error">{errors.code_user}</div>}
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        />
                        {errors.identite && <div className="error">{errors.identite}</div>}
                      </div>
                    </div>
                  </div>
                  <div className="form-row">
                  ...
                  {userData.role === 'client' && (
                    <div className="form-group">
                      ...
                      {errors.code_entreprise && <div className="error">{errors.code_entreprise}</div>}
                    </div>
                  )}
