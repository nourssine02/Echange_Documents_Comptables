...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Données envoyées :', userData); // Ajoutez un log pour afficher les données envoyées
    ...
    if (Object.values(inputValidity).every((valid) => valid)) {
        try {
            console.log("Envoi de la requête POST à l'API..."); // Log avant l'appel API
