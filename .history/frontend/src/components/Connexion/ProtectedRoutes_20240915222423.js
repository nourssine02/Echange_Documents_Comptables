...
import LivraisonsAvecRetard from "../Requêtes/LivraisonsAvecRetard";
  ...
  return (
    <div className={`container-fluid page-body-wrapper ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <Routes>
        ...
        <Route path="/LivraisonsAvecRetard" element={<LivraisonsAvecRetard isSidebarOpen={isSidebarOpen} />}/>
