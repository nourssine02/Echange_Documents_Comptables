    ...
    Object.keys(userData).forEach((key) => {
      switch (key) {
        case 'code_user':
          ...
          break;
        case 'identite':
          newInputValidity[key] = userData[key] !== '' && !identites.some((item) => item.identite === userData[key]);
          break;
        case 'position':
          newInputValidity[key] = userData[key] !== '';
          break;
                ...
                <form className="pt-3" onSubmit={handleSubmit}>
                      ...
                      <div className="form-group">
                        <input
                          ...
                          className={`form-control form-control-lg ${
                            inputValidity.code_user ? 'is-valid' : errors.code_user ? 'is-invalid' : ''
                          }`}
                          name="code_user"
                        ...
                        />
                        {errors.code_user && (
                          <div className="invalid-feedback">{errors.code_user}</div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <input
                          type="text"
                          className={`form-control form-control-lg ${
                            inputValidity.identite ? 'is-valid' : errors.identite ? 'is-invalid' : ''
                          }`}
                          name="identite"
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <input
                          type="text"
                          className={`form-control form-control-lg ${
                            inputValidity.position ? 'is-valid' : errors.position ? 'is-invalid' : ''
                          }`}
                          name="position"
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <input
                          type="tel"
                          className={`form-control form-control-lg ${
                            inputValidity.tel ? 'is-valid' : errors.tel ? 'is-invalid' : ''
                          }`}
                          name="tel"
                          value={userData.tel}
                          onChange={handleChange}
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <input
                          type="email"
                          className={`form-control form-control-lg ${
                            inputValidity.email ? 'is-valid' : errors.email ? 'is-invalid' : ''
                          }`}
                          name="email"
                      ...
                      <div className="form-group">
                        <select
                          ...
                          className={`form-control ${
                            inputValidity.role ? 'is-valid' : errors.role ? 'is-invalid' : ''
                          }`}
                          name="role"
                          value={userData.role}
                          onChange={handleChange}
                  ...
                  {userData.role === 'client' && (
                    <div className="form-group">
                      <select
                        className={`form-control form-control-lg ${
                          inputValidity.code_entreprise ? 'is-valid' : errors.code_entreprise ? 'is-invalid' : ''
                        }`}
                        style={{ color: 'black' }}
                  ...
                  <div className="form-group">
                    <input
                      type="password"
                      className={`form-control form-control-lg ${
                        inputValidity.mot_de_passe ? 'is-valid' : errors.mot_de_passe ? 'is-invalid' : ''
                      }`}
                      name="mot_de_passe"
