  ...
  return (
    <div className={`container-fluid page-body-wrapper ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <Routes>
        ...
        <Route path="/CommandesParCodeClient" element={<LivraisonsPrevues isSidebarOpen={isSidebarOpen} />}/>
        <Route path="/LivraisonsAvecRetard" element={<LivraisonsPrevues isSidebarOpen={isSidebarOpen} />}/>
        <Route path="/FacturesNonPayee" element={<LivraisonsPrevues isSidebarOpen={isSidebarOpen} />}/>
