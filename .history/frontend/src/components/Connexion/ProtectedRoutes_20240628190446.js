  ...
  return (
    <div className={`container-fluid page-body-wrapper ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <Routes>
        ...
        <Route path="/ListeClientsParPeriodeCreation" element={<TotalCommandesParPeriode isSidebarOpen={isSidebarOpen} />}/>
        <Route path="/EtatDeFacturation" element={<TotalCommandesParPeriode isSidebarOpen={isSidebarOpen} />}/>
