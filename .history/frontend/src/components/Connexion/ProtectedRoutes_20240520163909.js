...
const ProtectedRoutes = () => {
  ...
  return (
    <div className="container-fluid page-body-wrapper">
      ...
      <Routes>
        ...
        {/* Routes spécifiques au Super Admin */}
        {isAdmin && (
          <>
 <Route path="/entreprises" element={<Entreprises />} />
              ...
              <Route
                path="/detailsVersement/:id"
                element={<DetailsVersement />}
              />
              <Route
                path="/updateVersement/:id"
                element={<UpdateVersement />}
              />

          </>
        )}

        {/* Routes spécifiques au Comptable Expert */}
        {isComptableExpert && (
          <>
            <Route path="/entreprises" element={<Entreprises />} />
            ...
            <Route path="/reglements_recus" element={<ReglementsRecus />} />
            <Route path="/addReglementRecu" element={<AddReglementRecu />} />
            <Route path="/detailsReglementRecu/:id" element={<DetailsReglementRecu />} />
            <Route path="/updateReglementRecu/:id" element={<UpdateReglementRecu />} />
            <Route path="/versements" element={<Versements />} />
            <Route path="/addVersement" element={<AddVersement />} />
            ...
            <Route path="/document_comptabilite" element={<DocumentComptabilite />} />
