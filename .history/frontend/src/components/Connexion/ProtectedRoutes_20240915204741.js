  ...
  return (
    <div className={`container-fluid page-body-wrapper ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <Routes>
        ...
        <Route path="/CommandeDetailleesParPeriode" element={<EtatVersementParPeriode isSidebarOpen={isSidebarOpen} />}/>
        <Route path="/LivraisonsPrevues" element={<EtatVersementParPeriode isSidebarOpen={isSidebarOpen} />}/>
