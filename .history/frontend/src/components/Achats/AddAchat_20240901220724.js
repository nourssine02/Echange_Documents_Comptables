    ...
    if (name === 'num_piece') {
      try {
        ...
        if (response.data.exists) {
          ...
          // Afficher une alerte de confirmation avant de continuer
          Swal.fire({
    ...
    if (!hasErrors) {
      ...
      try {
        ...
        if (response.data.exists) {
          ...
          setErrors((prevErrors) => ({ ...prevErrors, num_piece: 'N° de la Pièce déjà existant' }));
