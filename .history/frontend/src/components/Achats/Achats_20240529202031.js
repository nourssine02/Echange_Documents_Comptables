...
const Achats = () => {
  ...
  const filteredAchats = achats.filter((achat) =>
    ...
    new Date(achat.date_saisie).toLocaleDateString().includes(searchTerm) ||
    achat.montant_total_piece.toString().includes(searchTerm) ||
    achat.statut.toLowerCase().includes(searchTerm.toLowerCase()) ||
    achat.num_piece.toLowerCase().includes(searchTerm.toLowerCase())
  );
