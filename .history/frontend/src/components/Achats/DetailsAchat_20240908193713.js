...
const DetailsAchat = ({ isSidebarOpen }) => {
  ...
  if (loading) {
    return <div className="d-flex justify-content-center align-items-center"><p>Chargement des détails...</p></div>;
  }
                  ...
                  <li>
                    ...
                    {achat.document_fichier ? (
                      <img
                        ...
                        onError={(e) => { e.target.src = ''; alert("Image invalide ou corrompue."); }}
                      />
                    ) : (
