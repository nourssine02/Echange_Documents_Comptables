...
const DetailsAchat = ({ isSidebarOpen }) => {
  ...
  const openDocumentInNewWindow = (achat) => {
    ...
    // On s'assure que c'est un document Base64 et on extrait la donnée sans le préfixe "data:"
    const base64Data = achat.document_fichier.includes('base64')
      ? achat.document_fichier.split(',')[1]  // Extraire la partie Base64
    ...
    // Ouvrir une nouvelle fenêtre pour afficher l'image
      ...
      newWindow.document.write(`
        ...
        <body>
          ...
          <div class="print">
            ...
            <a href="${blobUrl}" download="document_image.jpg">
