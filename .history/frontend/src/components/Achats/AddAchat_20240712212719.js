...
const AddAchat = ({ isSidebarOpen }) => {
  ...
  const handleMultiSelectChange = (selectedOptions) => {
    const selectedBanques = selectedOptions ? selectedOptions.map(option => option.value) : [];
    ...
    <div className="main-panel">
      <div className={`content-wrapper ${isSidebarOpen ? "shifted" : ""}`}>
          ...
          <Form>
            ...
            <Form.Group controlId="banques">
              ...
              <Select
                ...
                value={banquesOptions.filter(option => newTier.banques.includes(option.value))}
              />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button variant="info" onClick={handleModalSubmit}>
            Sauvegarder
          </Button>
        </Modal.Footer>
      </Modal>
