...
const DetailsAchat = ({ isSidebarOpen }) => {
  ...
  const openDocumentInNewWindow = (achat) => {
    let imageType = achat.document_fichier.startsWith("/9j/") ? "jpeg" : "png"; // Vérifier si c'est un JPEG ou PNG
    const imageDataUrl = `data:image/${imageType};base64,${achat.document_fichier}`;
    const newWindow = window.open("", "_blank");
    console.log(achat.document_fichier.substring(0, 50)); // Affiche les 50 premiers caractères pour vérifier
      ...
      newWindow.document.write(`
        ...
        <body>
          ...
          <div class="print">
            ...
            <a href="${imageDataUrl}" download="document_image.${imageType}">
