...
const AddAchat = ({ isSidebarOpen }) => {
  ...
  const handleClick = async (e) => {
    ...
    // setIsSubmitting(true); // Remove this line if 'isSubmitting' is not used
    ...
    // End form submission
    // setIsSubmitting(false); // Remove this line if 'isSubmitting' is not used
  };
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    >
                      <option value="">Sélectionnez le code du Tiers</option>
                      {codeTiers.map((tier) => (
        ...
        <Modal.Body>
          <Form>
            <Form.Group>
              ...
              <Form.Control
                type="text"
                placeholder="Entrez le code du Tiers"
                name="code_tiers"
            ...
            <Form.Group>
              ...
              <Form.Control
                type="text"
                placeholder="Entrez l'identité du Tiers"
                name="identite"
                onChange={handleModalChange}
