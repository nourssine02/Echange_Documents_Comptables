...
const AddAchat = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      // Si l'utilisateur est un comptable, récupérez l'identifiant du client sélectionné dans le formulaire
      if (user.role === "comptable") {
        postData.clientId = achat.clientId;
      } else {
        // Si l'utilisateur n'est pas un comptable, définissez clientId sur NULL
      ...
      await axiosInstance.post("http://localhost:5000/notifications", {
        userId: user.id,
