...
const DetailsAchat = ({ isSidebarOpen }) => {
  ...
  const openDocumentInNewWindow = (achat) => {
    ...
    if (achat.document_fichier) {
      // Correctly reference mime_type from achat object, or default to image/jpeg
      const mimeType = achat.mime_type || "image/jpeg";  // FIXED: Refer to mime_type from achat
      ...
      newWindow.document.write(`
        ...
        <body>
          ...
          <div class="print">
            ...
            <a href="${imageUrl}" download="document_image.${mimeType.split('/')[1]}">
