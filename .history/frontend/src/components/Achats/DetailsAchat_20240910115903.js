...
const DetailsAchat = ({ isSidebarOpen }) => {
  ...
  function openDocumentInNewWindow(achat) {
    if (!achat.document_fichier) {
      alert("Le fichier de l'image n'est pas disponible.");
      return;
    }
    ...
    if (newWindow) {
      newWindow.document.write(`
        ...
        <body>
          <img src="data:image/png;base64,${achat.document_fichier}" alt="Document Image">
          <br><br>
          <div class="print">
            <button onclick="window.print()">Print</button>
            <a href="data:image/png;base64,${achat.document_fichier}" download="document_image.png">
