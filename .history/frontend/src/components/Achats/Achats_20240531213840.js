...
import "./Achats.css";  // Assurez-vous de créer ce fichier CSS
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <MDBInputGroup className="search-bar" noBorder>
                    <MDBInput
                      type="text"
                ...
                <div className="table-container">
                  <table className="table table-hover table-table-responsive-sm">
                    <thead>
                      <tr>
                        <th>Ajouté par</th>
                    ...
                    <tbody>
                      {currentItems.map((achat) => (
                        <tr key={achat.id}>
                          ...
                          <td
                            className={achat.statut === "non réglée" ? "statut-non-reglee" : "statut-reglee"}
                          >
                            {achat.statut}
                          </td>
