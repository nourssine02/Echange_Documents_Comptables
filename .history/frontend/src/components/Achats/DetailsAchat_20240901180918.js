...
const DetailsAchat = ({isSidebarOpen}) => {
  ...
  function openDocumentInNewWindow(achat) {
    let imageUrl;
    if (typeof achat.document_fichier === 'string' && achat.document_fichier.startsWith("data:image")) {
      // Si le fichier est une chaîne Base64
      imageUrl = achat.document_fichier;
    } else if (achat.document_fichier instanceof Blob) {
      // Si le fichier est un BLOB
      imageUrl = URL.createObjectURL(achat.document_fichier);
    } else {
    ...
    // Libérer l'URL si elle a été créée à partir d'un BLOB
    if (achat.document_fichier instanceof Blob) {
      URL.revokeObjectURL(imageUrl);
    }
  }
  
  console.log("Type de document_fichier:", typeof achat.document_fichier);
console.log("Valeur de document_fichier:", achat.document_fichier);
      ...
      <div className="col-md-6">
          ...
          >
            <div className="card-body">
              <h1 className="card-title d-flex justify-content-center">Détails de l'Achat</h1>
              <ul className="list-ticked" style={{ fontSize: "16px" }}>
                ...
                <li>
                  <strong style={{ color: "#118ab2", fontWeight: "bold" }}>Date de la Pièce:</strong>                          
