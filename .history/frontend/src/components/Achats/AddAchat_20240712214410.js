                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="tiers_saisie"
                      onChange={handleChange}
                      onClick={handleOpenModal}                      value={achat.tiers_saisie}
                      data-toggle="modal"
                                ...
                                <div className="col-md-12">
                                  <div className="form-group">
                                    ...
                                    >
                                      ...
                                      <option value="AMEN BANK">
                                        AMEN BANK
                                      </option>
                                      <option value="ARAB TUNISIAN BANK">
                                        ARAB TUNISIAN BANK
                                      </option>
                                      ...
                                      <option value="BANQUE INTERNATIONALE ARABE DE TUNISIE (BIAT)">
                                      ...
                                      <option value="UNION INTERNATIONALE DE BANQUES">
