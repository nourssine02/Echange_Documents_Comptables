...
const DetailsAchat = ({ isSidebarOpen }) => {
  ...
  const openDocumentInNewWindow = (achat) => {
    ...
    const byteCharacters = atob(achat.document_fichier);  // Decode base64 string to binary
    ...
    const blob = new Blob([byteArray], { type: achat.mime_type || 'image/jpeg' });  // Default MIME type is 'image/jpeg'
      ...
      newWindow.document.write(`
        ...
        <body>
          ...
          <div class="print">
            ...
            <a href="${blobUrl}" download="document_image.${achat.mime_type.split('/')[1]}">
