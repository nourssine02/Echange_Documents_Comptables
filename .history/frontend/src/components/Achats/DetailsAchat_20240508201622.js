            ...
            <div className="card-body">
              ...
              <ul className="list-arrow" style={{ fontSize: "14px" }}>
                ...
                <li>
                  ...
                  {achat.montant_HT_piece}
                </li>
                <li>
                  <strong>FODEC sur la Pièce:</strong> {achat.FODEC_piece}
                </li>
                <li>
                  <strong>TVA de la Pièce:</strong> {achat.TVA_piece}
                </li>
                <li>
                  <strong>Timbre sur la Pièce:</strong> {achat.timbre_piece}
                </li>
                <li>
                  <strong>Autre Montant sur la Pièce:</strong>{" "}
                  {achat.autre_montant_piece}
                </li>
                <li>
                  <strong>Montant Total de la Pièce:</strong>{" "}
                  {achat.montant_total_piece}
                </li>
                <li>
