  ...
  <div className="modal-dialog modal-lg" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">Ajouter un nouveau tiers</h5>
        ...
        <form>
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                <label for="code_tiers">Code du Tiers:</label>
                <input type="text" className="form-control" id="code_tiers" placeholder="Code du Tiers" />
              </div>
            </div>
            <div className="col-md-6">
              <div className="form-group">
                <label for="identite">Identité:</label>
                <input type="text" className="form-control" id="identite" placeholder="Identité" />
              </div>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input type="text" className="form-control" id="autreType" placeholder="Autre Type" />
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                <label for="MF_CIN">MF/CIN:</label>
                <input type="text" className="form-control" id="MF_CIN" placeholder="MF/CIN" />
              </div>
            </div>
            <div className="col-md-6">
              <div className="form-group">
                <label for="tel">Téléphone:</label>
                <input type="text" className="form-control" id="tel" placeholder="Téléphone" />
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                ...
                <select multiple className="form-control" id="banques">
                  <option value="Al Baraka Bank">Al Baraka Bank</option>
                  <option value="AMEN BANK">AMEN BANK</option>
                  <option value="ARAB TUNISIAN BANK">ARAB TUNISIAN BANK</option>
                  <option value="ATTIJARI BANK">ATTIJARI BANK</option>
                  <option value="BANQUE DE TUNISIE">BANQUE DE TUNISIE</option>
                  <option value="BANQUE INTERNATIONALE ARABE DE TUNISIE (BIAT)">BANQUE INTERNATIONALE ARABE DE TUNISIE (BIAT)</option>
                  <option value="BH BANK">BH BANK</option>
                  <option value="BANQUE ZITOUNA">BANQUE ZITOUNA</option>
                  <option value="UNION INTERNATIONALE DE BANQUES">UNION INTERNATIONALE DE BANQUES</option>
                </select>
              </div>
            </div>
          </div>
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-info">Sauvegarder</button>
      </div>
    </div>
  </div>
</div>
