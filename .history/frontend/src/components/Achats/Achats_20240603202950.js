            ...
            <div className="card">
              <div className="card-body">
                <div className="w-full-width mb-5">
                  <h2 className="font-medium text-center">Liste des Achats de Biens et de Services</h2>
                </div>
                  ...
                  <table className="table table-sm table-hover">
                    <thead>
                      <tr>
                        ...
                        <th style={{ width: "10%" }}>Date de Saisie</th>
                        <th style={{ width: "10%" }}>Code Tiers</th>
                        <th style={{ width: "10%" }}>Type de la Pièce</th>
                        <th style={{ width: "10%" }}>N° de la Pièce</th>
                        <th style={{ width: "10%" }}>Date de la Pièce</th>
                        <th style={{ width: "10%" }}>Statut</th>
                        <th style={{ width: "10%" }}>Montant Total de la Pièce</th>
                ...
                <br />
                <br />
                <div className="d-flex justify-justify-content-sm-center">
                  <ReactPaginate
