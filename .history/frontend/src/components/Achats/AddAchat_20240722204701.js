...
const AddAchat = ({ isSidebarOpen }) => {
  ...
  const banquesOptions = [
    ...
    { id: 6 , value: "BANQUE INTERNATIONALE ARABE DE TUNISIE (BIAT)", label: "BANQUE INTERNATIONALE ARABE DE TUNISIE (BIAT)" },
    { id: 7 , value: "BH BANK", label: "BH BANK" },
    { id: 8 , value: "BANQUE ZITOUNA", label: "BANQUE ZITOUNA" },
    { id: 9 , value: "UNION INTERNATIONALE DE BANQUES", label: "UNION INTERNATIONALE DE BANQUES" },
  ];
  ...
  const handleNewTierSubmit = async (e) => {
    ...
    try {
      ...
      setAchat((prevAchat) => ({
        ...prevAchat,
        // Mettre à jour le champ tiers_saisie avec le nouveau tier ajouté
  ...
  >
    ...
    {codeTiers.map((tier) => (
      <option key={tier.id} value={`${tier.code_tiers} - ${tier.identite}`}>
        {`${tier.code_tiers} - ${tier.identite}`}
                ...
                <div className="col-md-4">
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="réglée">Partiellement réglée</option>
                      <option value="réglée">Totalement réglée</option>
            ...
            >
              ...
              <Modal.Footer>
                ...
                <Button className="btn btn-info" type="submit" onClick={handleNewTierSubmit}>
                  Sauvegarder
                </Button>
              </Modal.Footer>
            </Modal>
