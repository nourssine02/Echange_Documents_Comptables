          ...
          >
            <div className="card-body">
              ...
              <ul className="list-arrow" style={{ fontSize: "14px" }}>
                <li>
                  <strong >Date du Bon de Livraison:</strong> {livraison.date_BL}
                </li>
                <li>
                  <strong>N° du Bon de Livraison:</strong> {livraison.num_BL}
                </li>
                <li>
                  <strong>Code Tiers:</strong> {livraison.code_tiers}
                </li>
                <li>
                  <strong>Tiers à Saisir:</strong> {livraison.tiers_saisie}
                </li>
                <li>
                ...
                <li>
                  <strong>Montant HT du Bon de Livraison:</strong>{" "}
                  {livraison.montant_HT_BL}
                </li>
                <li>
                  <strong>TVA du Bon de Livraison:</strong> {livraison.TVA_BL}
                </li>
                <li>
                  <strong>Montant Total du Bon de Livraison:</strong>{" "}
                  {livraison.montant_total_BL}
                </li>
                <li>
                  <strong>Observations:</strong> {livraison.observations}
                </li>{" "}
                <li>
