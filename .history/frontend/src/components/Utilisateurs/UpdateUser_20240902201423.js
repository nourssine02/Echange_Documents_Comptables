...
const UpdateUser = ({ isSidebarOpen }) => {
  ...
  <select
    ...
    onChange={(e) => setUser({ ...user, role: e.target.value })} // Mise à jour du rôle dans l'état
    style={{ color: "black" }}
  >
    ...
    <option value="client">Client</option>
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    />
                    <span style={{fontSize : "12px"}}>NB: laissez vide si vous ne voulez pas le changer</span>
                  </div>
