    ...
    axios
      ...
      .then((res) => {
        ...
        setUser({
          ...
          tel: data.tel || "",
          email: data.email || "",
          mot_de_passe: data.plain_password || "", // Utiliser le mot de passe en clair renvoyé par le backend
          password_iv: data.password_iv || "", // Ajouter l'IV
          role: data.role || "",
        });
      })
      .catch((err) => console.log(err));
