...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.values(inputValidity).every((valid) => valid)) {
        try {
            ...
            const response = await axios.post("https://echange-documents-comptables-backend.vercel.app/register", userData);
  ...
  useEffect(() => {
    const fetchComptableCodes = async () => {
      try {
        const res = await axios.get("https://echange-documents-comptables-backend.vercel.app/comptables");
