...
const Facturations = ({ isSidebarOpen }) => {
  ...
  useEffect(() => {
    const fetchFactures = async () => {
      ...
      try {
        const res = await axios.get("https://echange-documents-comptables-backend.vercel.app/facturations", {
          headers: {
  ...
  const handlePaymentStatusChange = async (id, currentStatus) => {
    try {
      ...
      await axios.put(`https://echange-documents-comptables-backend.vercel.app/facture/${id}/etat_payement`, {
