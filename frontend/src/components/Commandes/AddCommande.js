...
const AddCommande = ({ isSidebarOpen }) => {
    ...
    useEffect(() => {
        const fetchFamilles = async () => {
            try {
                const res = await axios.get("https://echange-documents-comptables-backend.vercel.app/familles");
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            try {
                await axios.post("https://echange-documents-comptables-backend.vercel.app/commande", { commande, familles },
                    {
                        headers: {
