...
const FichePaie = ({ isSidebarOpen }) => {
  ...
  useEffect(() => {
    const fetchFiches = async () => {
      ...
      try {
        const res = await axios.get("https://echange-documents-comptables-backend.vercel.app/pointage", {
          headers: {
   ...
   const handleDeleteSelected = async () => {
    try {
      await axios.delete("https://echange-documents-comptables-backend.vercel.app/pointage", {
